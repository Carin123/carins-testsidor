...
* Annat bärarformat/Instans/Har titel/Huvudtitel (otherPhysicalFormat/Instance/hasTitle/Title/mainTitle = 776 ‡t)  
...
* Annat bärarformat/Instans/Identifikatorl/ISSN/Värde (otherPhysicalFormat/Instance/identifiedBy/ISSN/value = 776 ‡x)  
