...
* Utgivning (publication)  
  ...
  * År (= Utgivningstid) (date = 008/07-10, 264 -/1 ‡c)  
  ...
  För att ange ett år utan klamrar eller andra tecken, ange det endast här. Det kommer då att följa med till både 08/07-10 och 264 -/1 ‡c. För att ange klamrar eller andra tecken utöver fyra positioner, använd Datum.  
  ```Exempel: 2017```  
