...
```Har del```  
```Utökad innehållsanmärkning:```  
```Kommentar: D. 2 med eget titelblad (s. [335]):```  
```Benämning: Martini Opitii Deutscher poematum Anderer Theil; zuvor nie beysammen, theils auch noch nie herauszgegeben.```  
