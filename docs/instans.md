...
* Flera år (faksimil)  
  Använd Omtryck/återutgivning och originalutgivning i stället för Primär utgivning. Lägg till Årtal för ursprunglig utgivning och Årtal för ny utgivning. Lägg sedan till Utgivning och lägg till Plats, Land, Agent och År samt vid behov Datum.     
