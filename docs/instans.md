...
*	Huvudsakligt tillgängliggörande (marc:primaryProvisionActivity = 264 -/0 ‡b)  
  Ta med Huvudsakligt tillgängliggörande när egenskapen Produktion används och det inte gäller en samlingspost. Egenskapen används även tillsammans med Utgivning/Startår och Utgivning/Slutår i de fall detta är osäkert men tidigaste och senaste år kan anges.
