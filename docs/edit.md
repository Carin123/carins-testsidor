...
### Uppgradera
Med uppgradera menas att komplettera och redigera posten enligt anvisningar (se Checklista Librispraxis) och därefter ändra beskrivningsnivå. Många poster kommer in som förhandsinformation eller på preliminär nivå. Katalogisatören uppgraderar posten när ett exemplar finns tillgängligt och ändrar till godkänd beskrivningsnivå. Läs mer om beskrivningsnivå under Adminmetadata, Beskrivningsnivå.
