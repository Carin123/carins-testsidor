...
* [Verk](https://libris.kb.se/katalogisering/help/workflow-work) – en beskrivning av det verk som instansen är en instans av. Återger egenskaper såsom medverkan och funktion (t. ex. författare), ämne, klassifikation, språk och innehållstyp. Verksbeskrivningen ligger under rubriken Instans av verk.
